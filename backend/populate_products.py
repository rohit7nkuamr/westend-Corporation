...
vertical, created = Vertical.objects.get_or_create(
    ...
    defaults={
        'description': "A wide range of premium quality processed food items including snacks, beverages, sauces, and instant mixes.",
        'icon_name': 'Package',
...
for line in raw_list.strip().split('\n'):
    ...
    if Product.objects.filter(name__iexact=line).exists():
        print(f"Skipping existing: {line}")
        continue
        
    # Determine packaging/description based on keywords
    ...
    if os.path.exists(placeholder_path):
        ...
        print("Warning: Placeholder image not found!")
        product.save()
        count += 1

print(f"Successfully added {count} products to 'Processed Foods'.")
