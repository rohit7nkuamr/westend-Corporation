        ...
        <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-3">
            ...
            >
                ...
                <div className="flex flex-col items-start z-10 w-full">
                    <span className="text-xs text-primary-400 font-medium tracking-wider uppercase mb-0.5">
                        Exclusive Access
                    </span>
                    <span className="font-bold text-white text-lg tracking-wide group-hover:text-primary-400 transition-colors">
                        DOWNLOAD CATALOG
                    </span>
                ...
                <div className="relative z-10 p-2 rounded-full bg-primary-500/10 group-hover:bg-primary-500/20 transition-colors border border-primary-500/30">
                    <Download className="w-5 h-5 text-primary-400 group-hover:text-primary-300 transition-colors" />
                </div>
            </button>
        </div>
    );
